...
| RED-006 | PLAYTHROUGH | FACTION | P11 | Луны нет в правилах: Moon Systems не контролирует ни одной фабрики и не получает влияния за фабрики | ERROR | APPLIED | D-049 |
...
| RED-009 | PLAYTHROUGH | DOOM | P11 | «Взлом систем» читается как второе оказание давления за фазу и перебивает §6.3 через §3.9 | WARNING | APPLIED | D-045 |
