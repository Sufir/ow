...
# ---------------------------------------------------------------- ассеты
LOGO = {
 'Островная Империя': 'Островная Империя.png', 'Эйркрафт Корпорейшн': 'Эйркрафт Корпорешн.png',
...
UNITS = {
 ...
 'Эйркрафт Корпорейшн': {'Рекрут':'Units/adept.png','Полковник':'Units/colonel.png',
   'Дрон “Ночной призрак”':'Units/АиркрафтКорпорэйшн/Ночной призрак.png',
   'Самолет “Фантом”':'Units/АиркрафтКорпорэйшн/Фантом.png',
   'Робот “Небесный охотник”':'Units/АиркрафтКорпорэйшн/Небесный охотник.png',
   'Спрут':'Units/АиркрафтКорпорэйшн/Спрут.png'},
